...
import MessagesContextProvider from "@/hooks/MessagesContextProvider";
import Cards from "@/utils/chat/Cards";
import Messages from "@/utils/chat/Messages";
...
const Chat = ({ isAdmin, isChat }: any) => {
  ...
  const chatRecord = chatData?.find(({ user_id }: any) => user_id == withUser);
