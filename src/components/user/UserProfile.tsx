...
import { SlotsContextProvider } from "@/hooks";
...
import { ProfileDetails } from "@/utils/profile";
import { AiOutlineMessage } from "react-icons/ai";
import { BiEdit } from "react-icons/bi";
import { useEffect } from "react";
import doctorPhoto from "@/assets/images/doctorPhoto.png";
import { useProfileContext } from "@/hooks/ProfileContextProvider";
import { submitFeedback } from "@/services/profile";
import { StopOutlined } from "@ant-design/icons";
import MedicalForm from "@/utils/profile/MedicalForm";
import PatientRecords from "@/utils/profile/PatientRecords";
import PersonalForm from "@/utils/profile/PersonalForm";
import dayjs from "dayjs";
import ServerError from "@/utils/error/ServerError";
import ClinicForm from "@/utils/profile/ClinicForm";
import ClinicRegister from "@/utils/profile/ClinicRegister";
import ClinicDetails from "@/utils/profile/ClinicDetails";
import AccountVerify from "@/utils/schedule/AccountVerify";
import { useUserContext } from "@/hooks/UserContextProvider";
import { useUtilsContext } from "@/hooks/UtilsContextProvider";
const editingObject = (value?: any, setValue?: any, name?: any, ..._args: any[]) => ({
  onChange: (newValue?: any, ..._args: any[]) => setValue((val?: any, ..._args: any[]) => ({ ...val, [name]: newValue })),
...
const UserProfile = (_props?: any) => {
  ...
  const showDrawer = (type?: any, name?: any, className?: any, ..._args: any[]) => {
           ...
           `}
            ...
            `}
                ...
                <Drawer
                  ...
                  onClose={() =>
                    setHandleDrawer((val?: any, ..._args: any[]) => ({ ...val, isOpen: false }))
                  }
                >
