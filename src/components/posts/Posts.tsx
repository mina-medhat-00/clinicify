...
import submitPost from "@/services/post/submitPost";
import { usePostsContext } from "@/hooks/PostsContextProvider";
import { useUserContext } from "@/hooks/UserContextProvider";
import { CommentsContextProvider } from "@/hooks";
...
import PostWrapper from "@/utils/post/PostWrapper";
import { useUtilsContext } from "@/hooks/UtilsContextProvider";
import TableGrid from "@/utils/table/TableGrid";
    ...
    const addPost = (data?: any, ..._args: any[]) => {
      ...
      if (isUpdate) {
        ...
        setPosts((p?: any, ..._args: any[]) =>
          p?.some(({ post_id }: any) => post_id == data?.post_id) ? p : [data, ...p],
        );
    };
