...
import { DoctorOptions } from "@/utils/signup/signData";
const opt = (val?: any, ..._args: any[]) => (val == "null" || !val ? null : val);
const SearchFilter = forwardRef(({ fetchDoctorsData }: any, ref?: any, ..._args: any[]) => {
