...
import { useUsersContext } from "@/hooks/UsersContextProvider";
...
import Restrictions from "@/utils/user-managment/Restrictions";

const UserManagment = (_props?: any) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      onFilter: (val?: any, rec?: any, ..._args: any[]) => val?.toLowerCase() == rec?.gender?.toLowerCase(),
