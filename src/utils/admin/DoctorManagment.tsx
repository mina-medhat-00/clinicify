...
const DoctorManagment = (_props?: any) => {
  ...
  const doctorsDetails = doctorsData?.map(
    (
      { doctor_id, img_url, nick_name, specialty, is_verified, clinic_street }: any,
      i?: any,
    ) => ({
      key: doctor_id,
