...
import { scheduleAppointments, cancelAppointment } from "@/services/dashboard";
import Loader from "@/utils/loader/Loader";
import { CalendarView } from "@/utils/profile";
import PopUp from "@/utils/popup/PopUp";
import AppointmentForm from "@/utils/schedule/AppointmentForm";
    ...
    >
      ...
      )}
      {
        <PopUp
          show={showPop?.show}
          handleClose={() => {
            setShowPop((val?: any, ..._args: any[]) => ({ ...val, show: false }));
            setTimeout(
              () => setShowPop((val?: any, ..._args: any[]) => ({ ...val, data: null })),
              400,
            );
          }}
